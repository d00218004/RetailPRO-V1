...
public class JNumberKeys extends javax.swing.JPanel {
    ...
    private void initComponents()
    {
        ...
        m_jEquals.setBackground(new java.awt.Color(0, 128, 255));
        m_jEquals.setIcon(new javax.swing.ImageIcon(getClass().getResource("/com/openbravo/images/btnequals_white.png"))); // NOI18N
        m_jEquals.setBorderPainted(false);
