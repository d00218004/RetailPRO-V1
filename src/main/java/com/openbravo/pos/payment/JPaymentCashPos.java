...
//added 19.04.13 JDL removal of text on payment buttons if required.   
    ...
    private void initComponents()
    {
        ...
        m_jChangeEuros.setFont(new java.awt.Font("Arial", 1, 14)); // NOI18N
        ...
        m_jChangeEuros.setPreferredSize(new java.awt.Dimension(170, 30));
        jPanel4.add(m_jChangeEuros);
        m_jChangeEuros.setBounds(120, 36, 230, 30);
        ...
        m_jMoneyEuros.setBounds(120, 4, 230, 30);
        ...
        m_jTendered.setPreferredSize(new java.awt.Dimension(132, 30));
