...
// remove all leading zeros from the string
   ...
   */
    ...
    private void initComponents()
    {
        ...
        m_jbtnScale.setFont(new java.awt.Font("Open Sans Condensed ExtraBold", 0, 14)); // NOI18N
        ...
        jbtnMooring.setFont(new java.awt.Font("Open Sans Condensed ExtraBold", 0, 14)); // NOI18N
        jbtnMooring.setText(bundle.getString("button.moorings")); // NOI18N
        jbtnMooring.setMargin(new java.awt.Insets(2, 2, 2, 2));
        jbtnMooring.setMaximumSize(new java.awt.Dimension(80, 40));
        jbtnMooring.setMinimumSize(new java.awt.Dimension(80, 40));
        jbtnMooring.setPreferredSize(new java.awt.Dimension(90, 50));
        ...
        m_jButtons.setPreferredSize(new java.awt.Dimension(282, 60));

        btnSplit.setFont(new java.awt.Font("Open Sans Condensed ExtraBold", 0, 14)); // NOI18N
        btnSplit.setText("SPLIT SALE");
        ...
        btnReprint1.setFont(new java.awt.Font("Open Sans Condensed ExtraBold", 0, 14)); // NOI18N
        btnReprint1.setText("REPRINT");
        ...
        j_btnRemotePrt.setFont(new java.awt.Font("Open Sans Condensed ExtraBold", 0, 14)); // NOI18N
        ...
        jPanel5.setMinimumSize(new java.awt.Dimension(110, 230));
        jPanel5.setPreferredSize(new java.awt.Dimension(140, 110));
        jPanel5.setLayout(new java.awt.BorderLayout());

        jPanel2.setBorder(javax.swing.BorderFactory.createEmptyBorder(0, 5, 0, 5));
        jPanel2.setMinimumSize(new java.awt.Dimension(120, 250));
        jPanel2.setPreferredSize(new java.awt.Dimension(100, 500));
        jPanel2.setLayout(new java.awt.GridLayout(0, 1, 5, 5));

        jBtnCustomer.setFont(new java.awt.Font("Tahoma", 0, 12)); // NOI18N
        jBtnCustomer.setIcon(new javax.swing.ImageIcon(getClass().getResource("/com/openbravo/images/user.png"))); // NOI18N
        jBtnCustomer.setText("Club Account");
        ...
        jBtnCustomer.setMargin(new java.awt.Insets(4, 4, 4, 4));
        ...
        m_jList.setMargin(new java.awt.Insets(4, 4, 4, 4));
        ...
        m_jEditLine.setMargin(new java.awt.Insets(4, 4, 4, 4));
        ...
        m_jDelete.setMargin(new java.awt.Insets(4, 4, 4, 4));
        ...
        jCheckStock.setHorizontalAlignment(javax.swing.SwingConstants.LEFT);
        jCheckStock.setHorizontalTextPosition(javax.swing.SwingConstants.RIGHT);
        jCheckStock.setLabel("Stock Check");
        jCheckStock.setMargin(new java.awt.Insets(4, 4, 4, 4));
