...
public class JTicketsBagShared extends JTicketsBag {
    ...
    */
    ...
    private void initComponents()
    {
        ...
        m_jReprintTickets.setFont(new java.awt.Font("Open Sans Condensed ExtraBold", 0, 14)); // NOI18N
        m_jReprintTickets.setText("REPRINT");
        ...
        m_jReprintTickets.setPreferredSize(new java.awt.Dimension(90, 50));
        ...
        m_jNewTicket.setBackground(new java.awt.Color(0, 128, 255));
        m_jNewTicket.setFont(new java.awt.Font("Open Sans Condensed ExtraBold", 0, 14)); // NOI18N
        m_jNewTicket.setForeground(new java.awt.Color(255, 255, 255));
        m_jNewTicket.setText("NEW SALE");
        m_jNewTicket.setToolTipText(bundle.getString("tooltip.addnewticket")); // NOI18N
        m_jNewTicket.setBorderPainted(false);
        ...
        m_jNewTicket.setPreferredSize(new java.awt.Dimension(90, 50));
        ...
        m_jDelTicket.setBackground(new java.awt.Color(255, 0, 0));
        m_jDelTicket.setFont(new java.awt.Font("Open Sans Condensed ExtraBold", 0, 14)); // NOI18N
        m_jDelTicket.setForeground(new java.awt.Color(255, 255, 255));
        m_jDelTicket.setText("CANCEL SALE");
        m_jDelTicket.setToolTipText(bundle.getString("tooltip.delete")); // NOI18N
        m_jDelTicket.setBorderPainted(false);
        ...
        m_jDelTicket.setPreferredSize(new java.awt.Dimension(90, 50));
        ...
        m_jListTickets.setFont(new java.awt.Font("Open Sans Condensed ExtraBold", 0, 14)); // NOI18N
        m_jListTickets.setIcon(new javax.swing.ImageIcon(getClass().getResource("/com/openbravo/images/sale_pending.png"))); // NOI18N
        m_jListTickets.setText("PARKED SALES");
        ...
        m_jListTickets.setPreferredSize(new java.awt.Dimension(90, 50));
        ...
        m_jHold.setFont(new java.awt.Font("Open Sans Condensed ExtraBold", 0, 14)); // NOI18N
        ...
        m_jHold.setPreferredSize(new java.awt.Dimension(90, 50));
